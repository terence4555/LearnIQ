...
const SECTIONS = [
  ...
  { key: "vocabulary", label: "Vocabulary", href: "/english/vocabulary", description: "Synonymes, phrasal verbs, collocations..." },
  { key: "reading", label: "Reading", href: "/english/reading", description: "Compréhension de textes" },
];
